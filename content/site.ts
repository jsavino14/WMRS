...
export const home = {
  hero: {
    ...
    sub: "WMRS reads the bill line by line, renegotiates the rate, and takes the billing and the service calls off your desk. Temporary containers, international waste, equipment financing, repairs, portable restrooms, tank removals and reporting come with it. We split what we save you, 50/50. Find nothing and you owe nothing.",
